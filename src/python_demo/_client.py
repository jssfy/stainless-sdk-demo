...
ENVIRONMENTS: Dict[str, str] = {
    ...
    "environment_1": "https://staging-api.example.com/v1",
}


class PythonDemo(SyncAPIClient):
    # client options
    api_key: str | None
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous PythonDemo client instance.

        This automatically infers the `api_key` argument from the `PYTHON_DEMO_API_KEY` environment variable if it is not provided.
        """
        if api_key is None:
            api_key = os.environ.get("PYTHON_DEMO_API_KEY")
        self.api_key = api_key

        self._environment = environment

        base_url_env = os.environ.get("PYTHON_DEMO_BASE_URL")
        if is_given(base_url) and base_url is not None:
            ...
            if base_url_env and base_url is not None:
                raise ValueError(
                    "Ambiguous URL; The `PYTHON_DEMO_BASE_URL` env var and the `environment` argument are given. If you want to use the environment, you must pass base_url=None",
                )
        ...
        custom_headers_env = os.environ.get("PYTHON_DEMO_CUSTOM_HEADERS")
    ...
    def with_raw_response(self) -> PythonDemoWithRawResponse:
        return PythonDemoWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> PythonDemoWithStreamedResponse:
        return PythonDemoWithStreamedResponse(self)
...
class AsyncPythonDemo(AsyncAPIClient):
    # client options
    api_key: str | None
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async AsyncPythonDemo client instance.
    ...
    def with_raw_response(self) -> AsyncPythonDemoWithRawResponse:
        return AsyncPythonDemoWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> AsyncPythonDemoWithStreamedResponse:
        return AsyncPythonDemoWithStreamedResponse(self)
...
class PythonDemoWithRawResponse:
    _client: PythonDemo

    def __init__(self, client: PythonDemo) -> None:
        self._client = client
...
class AsyncPythonDemoWithRawResponse:
    _client: AsyncPythonDemo

    def __init__(self, client: AsyncPythonDemo) -> None:
        self._client = client
