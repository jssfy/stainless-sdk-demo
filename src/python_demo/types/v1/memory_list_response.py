...
__all__ = [
    ...
    "ResultMemoryEpisodicMemoryModelMetadata",
    "ResultMemoryEventLogModel",
    "ResultMemoryEventLogModelMetadata",
    "ResultMemoryForesightModel",
    "ResultMemoryForesightModelMetadata",
    "ResultMetadata",
]
...
class ResultMemoryEpisodicMemoryModelMetadata(BaseModel):
    memory_type: str
...
class ResultMemoryEpisodicMemoryModel(BaseModel):
    ...
    metadata: Optional[ResultMemoryEpisodicMemoryModelMetadata] = None
...
class ResultMemoryEventLogModelMetadata(BaseModel):
    memory_type: str
...
class ResultMemoryEventLogModel(BaseModel):
    ...
    metadata: Optional[ResultMemoryEventLogModelMetadata] = None
...
class ResultMemoryForesightModelMetadata(BaseModel):
    memory_type: str
...
class ResultMemoryForesightModel(BaseModel):
    ...
    metadata: Optional[ResultMemoryForesightModelMetadata] = None
